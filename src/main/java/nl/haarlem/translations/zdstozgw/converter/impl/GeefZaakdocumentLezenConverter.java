...
public class GeefZaakdocumentLezenConverter extends Converter {
	...
	public String convertToZgw(RequestResponseCycle session, ZGWClient zgwClient, ConfigService configService,
		...
		try {
			...
			bv03.xpathDocument.setNodeValue(".//zkn:antwoord//zkn:object//zkn:creatiedatum",
					edcLa01.antwoord.object.creatiedatum.replace("-", ""));

			// bv03.xpathDocument.setNodeValue(".//zkn:antwoord//zkn:object//beschrijving",
			// edcLa01.antwoord.object.dctCategorie);
			bv03.xpathDocument.setNodeValue(".//zkn:antwoord//zkn:object//zkn:beschrijving",
					edcLa01.antwoord.object.dctOmschrijving);
			bv03.xpathDocument.setNodeValue(".//zkn:antwoord//zkn:object//zkn:identificatie",
					edcLa01.antwoord.object.identificatie);

			bv03.xpathDocument.setNodeValue(".//zkn:antwoord//zkn:object//zkn:inhoud", edcLa01.antwoord.object.inhoud);
			bv03.xpathDocument.setAttributeValue(".//zkn:antwoord//zkn:object//zkn:inhoud", "StUF:bestandsnaam",
					edcLa01.antwoord.object.bestandsnaam);

			// bv03.xpathDocument.setNodeValue(".//zkn:antwoord//zkn:object//zkn:link",
			// edcLa01.antwoord.object.link);

			/*
			 * if(edcLa01.antwoord.object.ontvangstdatum == null ||
			 * edcLa01.antwoord.object.ontvangstdatum == "") {
			 * log.info("hier ontvangstdatum:" + edcLa01.antwoord.object.ontvangstdatum);
			 * bv03.xpathDocument.setNodeValue(
			 * ".//zkn:antwoord//zkn:object//zkn:ontvangstdatum", "00010101"); } else {
			 * log.info("daart ontvangstdatum:" + edcLa01.antwoord.object.ontvangstdatum);
			 * bv03.xpathDocument.setNodeValue(
			 * ".//zkn:antwoord//zkn:object//zkn:ontvangstdatum",
			 * edcLa01.antwoord.object.ontvangstdatum.replace("-", "")); }
			 */

			// bv03.xpathDocument.setNodeValue(".//zkn:antwoord//zkn:object//zkn:status",
			// edcLa01.antwoord.object.status);
