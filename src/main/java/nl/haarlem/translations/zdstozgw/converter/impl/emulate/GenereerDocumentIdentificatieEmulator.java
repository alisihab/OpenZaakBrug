...
public class GenereerDocumentIdentificatieEmulator extends Converter {
	...
	public GenereerDocumentIdentificatieEmulator(RequestHandlerContext context, Translation translation,
	...
	public void load() throws ResponseStatusException {
		this.zdsDocument = (ZdsGenereerDocumentIdentificatieDi02) XmlUtils.getStUFObject(getContext().getRequestBody(),
