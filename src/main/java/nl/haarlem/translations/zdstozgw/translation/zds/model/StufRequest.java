...
public class StufRequest {
	...
	public StufRequest(Document _soapDocument) {
		this.body = _soapDocument;
	}

	public boolean isVoegZaakdocumentToe() {
		NodeList actualiseerZaakstatusZakLk01Nodes = this.body.getElementsByTagNameNS(
	...
	public boolean isgeefZaakDetails() {
		NodeList geefZaakdetails_zakLv01Nodes = this.body
	...
	public boolean isgeefLijstZaakdocumenten() {
		NodeList geefZaakdetails_zakLv01Nodes = this.body.getElementsByTagNameNS(
