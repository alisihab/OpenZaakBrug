...
public class ZakLa01Zaakdetails {
    ...
    public void setIdentificatie(String identificatie){
        xpathDocument.setNodeValue("//zkn:identificatie", identificatie);
    }

    public void setOmschrijving(String omschrijving){
        xpathDocument.setNodeValue("//zkn:omschrijving", omschrijving);
    }

    public void setToelichting(String toelichting){
        xpathDocument.setNodeValue("//zkn:toelichting", toelichting);
    }

    public void setResultaat(String omschrijving, String toelichting){
        xpathDocument.setNodeValue("//zkn:resultaat/zkn:omschrijving", omschrijving);
        xpathDocument.setNodeValue("//zkn:resultaat/zkn:toelichting", toelichting);
    }

    public void setStartDatum(String startDatum){
        xpathDocument.setNodeValue("//zkn:startdatum", startDatum);
    }

    public void setRegistratieDatum(String registratieDatum){
        xpathDocument.setNodeValue("//zkn:registratiedatum", registratieDatum);
    }

    public void setPublicatieDatum(String publicatieDatum){
        if(publicatieDatum != null){
            xpathDocument.setNodeValue("//zkn:publicatiedatum",publicatieDatum);
        } else {
            xpathDocument.setNodeEmpty("//zkn:publicatiedatum");
        }
    }

    public void setEinddatumGepland(String einddatumGepland){
        if(einddatumGepland != null){
            xpathDocument.setNodeValue("//zkn:einddatumGepland",einddatumGepland);
        } else {
            xpathDocument.setNodeEmpty("//zkn:einddatumGepland");
        }
    }

    public void setUiterlijkeEinddatum(String uiterlijkeEinddatum){
        if(uiterlijkeEinddatum != null){
            xpathDocument.setNodeValue("//zkn:uiterlijkeEinddatum",uiterlijkeEinddatum);
        } else {
            xpathDocument.setNodeEmpty("//zkn:uiterlijkeEinddatum");
        }
    }

    public void setEinddatum(String einddatum){
        if(einddatum != null){
            xpathDocument.setNodeValue("//zkn:einddatum",einddatum);
        } else {
            xpathDocument.setNodeEmpty("//zkn:einddatum");
        }
    }

    public void setArchiefNominatie(String archiefNominate){
        xpathDocument.setNodeValue("//zkn:archiefnominatie",archiefNominate);
    }

    public void setDatumVernietigingDossier(String datumVernietigingDossier){
        if(datumVernietigingDossier == null){
            xpathDocument.setNodeValue("//zkn:datumVernietigingDossier",datumVernietigingDossier);
        } else {
            xpathDocument.setNodeEmpty("//zkn:datumVernietigingDossier");
        }

    }

    public void setEmptyResultaat(){
        xpathDocument.setNodeEmpty("//zkn:resultaat/zkn:omschrijving");
        xpathDocument.setNodeEmpty("//zkn:resultaat/zkn:toelichting");
    }

    public void setZaakTypeOmschrijving(String zaakTypeOmschrijving){
        xpathDocument.setNodeValue("//zkn:isVan/zkn:gerelateerde/zkn:omschrijving",zaakTypeOmschrijving);
    }

    public void setZaakTypeCode(String zaakTypeCode){
        xpathDocument.setNodeValue("//zkn:isVan/zkn:gerelateerde/zkn:code",zaakTypeCode);
    }

    public void setZaakTypeIngangsDatumObject(String zaakTypeIngangsDatumObject){
        xpathDocument.setNodeValue("//zkn:isVan/zkn:gerelateerde/zkn:ingangsdatumObject",zaakTypeIngangsDatumObject);
    }
