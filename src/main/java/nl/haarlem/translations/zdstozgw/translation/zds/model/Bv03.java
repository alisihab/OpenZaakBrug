...
public class Bv03 {
    ...
    public void setReferentienummer(String referentienummer) {
        xpathDocument.setNodeValue("//stuf:referentienummer", referentienummer);
    }

    private Document createBaseDocument() {
        var document = XmlUtils.convertStringToDocument("<stuf:Bv03Bericht xmlns:stuf=\"http://www.egem.nl/StUF/StUF0301\">\n" +
                "            <stuf:stuurgegevens>\n" +
